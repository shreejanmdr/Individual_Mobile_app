                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Email Address',
                      hintStyle: TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 17.0, color: Colors.grey.shade600),
                    ),
                  ),
                  SizedBox(
                    height: 15,
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      hintText: 'Password',
                      hintStyle: const TextStyle(fontFamily: 'WorkSansSemiBold', fontSize: 17.0, color: Colors.grey),
                      suffixIcon: GestureDetector(
                        onTap: () {
                          setState(() {
                            _obscureTextPassword = !_obscureTextPassword;
